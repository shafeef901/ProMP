...
from meta_mb.rllab_maml.envs.base import Env
from meta_mb.rllab_maml.misc.overrides import overrides
from meta_mb.rllab_maml.mujoco_py import MjModel, MjViewer
...
class MujocoEnv(Env):
    ...
    def release(self):
        ...
        from meta_mb.rllab_maml.mujoco_py.mjlib import mjlib
