...
from meta_mb.rllab.misc.tabulate import tabulate
from meta_mb.rllab.misc.console import mkdir_p, colorize
from meta_mb.rllab.misc.autoargs import get_all_parameters
...
def stub_to_json(stub_sth):
    from meta_mb.rllab.misc import instrument
