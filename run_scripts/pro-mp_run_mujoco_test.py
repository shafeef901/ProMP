...
if platform == 'darwin':
    os.environ['MUJOCO_PY_MJPRO_PATH'] = "/Users/shafeef/.mujoco/mjpro131"
...
if __name__=="__main__":
    ...
    print(meta_policy_search_path + "/data/pro-mp/" + args.exp + "/")
    load_path = meta_policy_search_path + "/data/pro-mp/" + args.exp + "/"
    ...
    if args.config_file: # load configuration from json file
        ...
        if args.dir.startswith("W"): # args.exp
            ...
            if platform == 'darwin':
                os.environ['MUJOCO_PY_MJPRO_PATH'] = "/Users/shafeef/.mujoco/mujoco200"
