...
def create_mlp(name,
    ...
    Args:
        ...
        input_var (tf.compat.v1.placeholder or tf.Variable or None): Input of the network as a symbolic variable
    ...
    Returns:
        input_var (tf.compat.v1.placeholder or tf.Variable): Input of the network as a symbolic variable
