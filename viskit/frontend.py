...
import core
from core import AttrDict, flatten
import sys
import argparse
import json
import numpy as np
...
def reload_data(data_paths):
    ...
    exps_data = core.load_exps_data(data_paths, args.disable_variant)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", default=True, action='store_true',
    ...
    # data_paths = os.path.join(meta_policy_search_path,'data/pro-mp/HalfCheetahRandDirecEnv/run_1623218903')
    data_paths = os.path.join(meta_policy_search_path,'data/experiments')
    print("Importing data from {path}...".format(path=[data_paths]))
    reload_data([data_paths])
