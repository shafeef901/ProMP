...
from meta_policy_search_model_based import spaces
from meta_policy_search_model_based.envs.base import Env
from meta_policy_search_model_based.mujoco_py import MjModel, MjViewer
...
class MujocoEnv(Env):
    ...
    def release(self):
        ...
        from meta_policy_search_model_based.mujoco_py.mjlib import mjlib
